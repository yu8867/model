...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("gpt2/training.log", encoding="utf-8"),  # ファイル保存
...
model = GPT2(vocab_size, token, hidden_size=hidden_size, n_block=n_block, n_head=n_head, device=device, dropout_rate=0.1)
model.to(device)
...
for epoch in range(epoch_num):
    ...
    if (epoch+1) % 10 == 0 and epoch != 0:
        ...
        plt.savefig(f'gpt2/train_loss_{epoch+1}.png')